        ...
        <Fragment>
            ...
            <div className="relative">
                <div
                    ...
                    className="flex items-center gap-2 w-full px-4 py-2.5 bg-slate-50 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all">
